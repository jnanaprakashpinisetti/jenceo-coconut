...
import cocnutTree from "../images/carousal/coconut-tree.jpg";
import cocnutFarm from "../images/carousal/coconut-farm.jpg";
import coconut from "../images/carousal//cocnuts.jpg";
        ...
        <div id="myCarousel" className="carousel slide" data-ride="carousel">
            ...
            <div className="carousel-inner">
                <div className="carousel-item carousel-1 active">
                    ...
                    <h2 >Best Tender Coconut Suppliyers <br></br> In Hyderabad</h2>
